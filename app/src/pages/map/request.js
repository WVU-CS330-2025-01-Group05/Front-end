 ...
 */
    ...
    */
    ...
    //Use the Geolocation API to get user location (longitude, Latitude) if they allow it
    var zip = 26505;


    //Use the Google Maps Geocoding API to retrieve an address from the coordinates (includes ZIPCODE)
